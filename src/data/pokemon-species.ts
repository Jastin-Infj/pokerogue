...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(Species.LUVDISC, 3, false, false, false, "Rendezvous Pokémon", Type.WATER, Type.FAIRY, 0.6, 8.7, Abilities.SWIFT_SWIM, Abilities.LOVERS_TIDE, Abilities.HYDRATION, 470, 73, 30, 75, 100, 65, 117, 225, 70, 116, GrowthRate.FAST, 25, false),
