...
export function initSpecies() {
  allSpecies.push(
    ...
    new PokemonSpecies(Species.RATICATE, 1, false, false, false, "Mouse Pokémon", Type.NORMAL, null, 0.7, 18.5, Abilities.RUN_AWAY, Abilities.GUTS, Abilities.HUSTLE, 518, 90, 111, 70, 50, 80, 117, 127, 70, 145, GrowthRate.MEDIUM_FAST, 50, true),
    new PokemonSpecies(Species.SPEAROW, 1, false, false, false, "Tiny Bird Pokémon", Type.NORMAL, Type.FLYING, 0.3, 2, Abilities.KEEN_EYE, Abilities.SNIPER, Abilities.PIERCING_STRIKE, 262, 40, 60, 30, 31, 31, 70, 255, 70, 52, GrowthRate.MEDIUM_FAST, 50, false),
    new PokemonSpecies(Species.FEAROW, 1, false, false, false, "Beak Pokémon", Type.NORMAL, Type.FLYING, 1.2, 38, Abilities.KEEN_EYE, Abilities.SNIPER, Abilities.PIERCING_STRIKE, 537, 85, 115, 85, 61, 81, 110, 90, 70, 155, GrowthRate.MEDIUM_FAST, 50, false),
    ...
    new PokemonSpecies(Species.ARBOK, 1, false, false, false, "Cobra Pokémon", Type.POISON, Type.DARK, 3.5, 65, Abilities.INTIMIDATE, Abilities.SHED_SKIN, Abilities.UNNERVE, 528, 90, 105, 69, 65, 109, 90, 90, 70, 157, GrowthRate.MEDIUM_FAST, 50, false),
    ...
    new PokemonSpecies(Species.MEGANIUM, 2, false, false, false, "Herb Pokémon", Type.GRASS, Type.FAIRY, 1.8, 100.5, Abilities.OVERGROW, Abilities.NONE, Abilities.FLUFFY, 535, 90, 62, 110, 83, 110, 80, 45, 70, 263, GrowthRate.MEDIUM_SLOW, 87.5, true),
    ...
    new PokemonSpecies(Species.FURRET, 2, false, false, false, "Long Body Pokémon", Type.NORMAL, null, 1.8, 32.5, Abilities.RUN_AWAY, Abilities.FRISK, Abilities.FLUFFY, 515, 115, 76, 84, 45, 75, 120, 90, 70, 145, GrowthRate.MEDIUM_FAST, 50, false),
    ...
    new PokemonSpecies(Species.UNOWN, 2, false, false, false, "Symbol Pokémon", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, GrowthRate.MEDIUM_FAST, null, false, false,
      new PokemonForm("A", "a", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("B", "b", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("C", "c", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("D", "d", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("E", "e", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("F", "f", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("G", "g", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("H", "h", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("I", "i", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("J", "j", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("K", "k", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("L", "l", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("M", "m", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("N", "n", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("O", "o", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("P", "p", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("Q", "q", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("R", "r", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("S", "s", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("T", "t", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("U", "u", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("V", "v", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("W", "w", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("X", "x", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("Y", "y", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("Z", "z", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.RONE_OF_POWER, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("!", "exclamation", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
      new PokemonForm("?", "question", Type.PSYCHIC, null, 0.5, 5, Abilities.LEVITATE, Abilities.NONE, Abilities.NONE, 496, 78, 72, 78, 112, 78, 78, 225, 70, 118, false, null, true),
    ),
    ...
    new PokemonSpecies(Species.DELIBIRD, 2, false, false, false, "Delivery Pokémon", Type.ICE, Type.FLYING, 0.9, 16, Abilities.VITAL_SPIRIT, Abilities.HUSTLE, Abilities.INSOMNIA, 565, 85, 85, 75, 115, 65, 135, 45, 50, 116, GrowthRate.FAST, 50, false),
    ...
    new PokemonSpecies(Species.DELCATTY, 3, false, false, false, "Prim Pokémon", Type.NORMAL, null, 1.1, 32.6, Abilities.CUTE_CHARM, Abilities.NORMALIZE, Abilities.WONDER_SKIN, 535, 90, 45, 70, 120, 80, 110, 60, 70, 140, GrowthRate.FAST, 25, false),
    ...
    new PokemonSpecies(Species.CASTFORM, 3, false, false, false, "Weather Pokémon", Type.NORMAL, null, 0.3, 0.8, Abilities.FORECAST, Abilities.NONE, Abilities.NONE, 520, 70, 100, 85, 110, 85, 70, 45, 70, 147, GrowthRate.MEDIUM_FAST, 50, false, true,
      new PokemonForm("Normal Form", "", Type.NORMAL, null, 0.3, 0.8, Abilities.FORECAST, Abilities.NONE, Abilities.NONE, 520, 70, 100, 85, 110, 85, 70, 45, 70, 147, false, null, true),
      new PokemonForm("Sunny Form", "sunny", Type.FIRE, null, 0.3, 0.8, Abilities.FORECAST, Abilities.NONE, Abilities.NONE, 520, 70, 100, 85, 110, 85, 70, 45, 70, 147),
      new PokemonForm("Rainy Form", "rainy", Type.WATER, null, 0.3, 0.8, Abilities.FORECAST, Abilities.NONE, Abilities.NONE, 520, 70, 100, 85, 110, 85, 70, 45, 70, 147),
      new PokemonForm("Snowy Form", "snowy", Type.ICE, null, 0.3, 0.8, Abilities.FORECAST, Abilities.NONE, Abilities.NONE, 520, 70, 100, 85, 110, 85, 70, 45, 70, 147),
    ),
    ...
    new PokemonSpecies(Species.LUVDISC, 3, false, false, false, "Rendezvous Pokémon", Type.WATER, Type.FAIRY, 0.6, 8.7, Abilities.SWIFT_SWIM, Abilities.HYDRATION, Abilities.LOVERS_TIDE, 470, 73, 30, 75, 100, 65, 117, 225, 70, 116, GrowthRate.FAST, 25, false),
